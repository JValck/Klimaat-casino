...
<div class="card-content">
  ...
  <strong>{{$valid?trans('messages.proficiat'):trans('messages.helaas')}}</strong>
  @if($valid)
...
<div class="card-action">
  <a class="btn waves-effect waves-light" type="submit" href="pinball/{{$id}}"><i class="material-icons right">skip_next</i>{{ trans('messages.doorgaan') }}</button>
</div>
</form>
@stop
